...
<div class="bg-white rounded-lg shadow-md p-6">
  <form action="<?php echo BASE_URL; ?>/posts/add" method="post" enctype="multipart/form-data">
    <div class="mb-4">
    ...
    <div class="mb-4">
      ...
      <span class="text-gray-500 text-xs">Upload a featured image for your post. Leave empty to use default.</span>
    </div>
